<template>
  <nav class="nav nav-tabs justify-content-center" id="nav-tab" role="tablist">
    <router-link class="nav-item nav-link" active-class="active" to="/hot">Hot</router-link>
    <!--<router-link class="nav-item nav-link" :to="{name:'hot', params:{resolution:resolution}}">Hot</router-link>-->
    <router-link class="nav-item nav-link" active-class="active" to="/my-secrets" >My Secrets</router-link>
    <router-link class="nav-item nav-link" active-class="active" to="/favorites" >Favorites</router-link>
